...
class KotlinAnalyzer {
            ...
            configuration.put(
                ...
                object : MessageCollector {
                    ...
                    override fun report(
                        ...
                        if (severity.isError) {
                            System.err.println("[$severity] $path:$line:$column $message")
                        }
                    }
                })
    ...
    private fun analyzeClass(ktClass: KtClass, fullContent: String, file: File, config: CddConfig): ClassAnalysis {
        ...
        val overLimit = totalIcp > classLimit.toDouble()
    ...
    fun resolveWeights(file: File, config: CddConfig): Map<String, Double> {
        val langKey = "kotlin"
    ...
    fun resolveIcpLimit(file: File, config: CddConfig): Int? {
        val langKey = "kotlin"
