...
import com.cdd.settings.CddRuleItem
import com.cdd.settings.LimitColumn
import com.cdd.settings.PatternColumn
...
class CddLimitsPanel {
    ...
    init {
        ...
        limitsTabs.addTab("Java", createTablePanel(TableView(javaLimitsModel)) { CddRuleItem(CddConstants.WILDCARD_ALL, 12) })
        limitsTabs.addTab("Kotlin", createTablePanel(TableView(kotlinLimitsModel)) { CddRuleItem(CddConstants.WILDCARD_ALL, 12) })
