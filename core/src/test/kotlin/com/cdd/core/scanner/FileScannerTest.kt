...
class FileScannerTest : DescribeSpec({
    ...
    describe("FileScanner") {
        it("should scan files recursively and filter by extension") {
            ...
            File(srcDir, "Test1.java").apply { writeText("package com.test;\nclass Test1 {}") }
            File(srcDir, "Test2.kt").apply { writeText("package com.test;\nclass Test2") }
            File(srcDir, "Test3.txt").apply { writeText("Not a source file") }
